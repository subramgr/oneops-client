...
public class BaseTest {
    ...
    private void initializeTestParameters(){
      ...
      oneopsUrl = (System.getProperty("ONEOPS_ENDPOINT") != null) ? 
                    System.getProperty("ONEOPS_ENDPOINT") : 
                      (System.getenv("ONEOPS_ENDPOINT") != null ? System.getenv("ONEOPS_ENDPOINT") : oneopsUrl);

      oneopsApiToken = (System.getProperty("ONEOPS_API_TOKEN") != null) ? 
                    System.getProperty("ONEOPS_API_TOKEN") : 
                      (System.getenv("ONEOPS_API_TOKEN") != null ? System.getenv("ONEOPS_API_TOKEN") : null);
                
      oneopsOrg = (System.getProperty("ONEOPS_ORG") != null) ? 
                    System.getProperty("ONEOPS_ORG") : 
                      (System.getenv("ONEOPS_ORG") != null ? System.getenv("ONEOPS_ORG") : null);
      
      oneopsAssembly = (System.getProperty("ONEOPS_ASSEMBLY") != null) ? 
                    System.getProperty("ONEOPS_ASSEMBLY") : 
                      (System.getenv("ONEOPS_ASSEMBLY") != null ? System.getenv("ONEOPS_ASSEMBLY") : null);
      
      oneopsEnv = (System.getProperty("ONEOPS_ENVIRONMENT") != null) ? 
                    System.getProperty("ONEOPS_ENVIRONMENT") : 
                      (System.getenv("ONEOPS_ENVIRONMENT") != null ? System.getenv("ONEOPS_ENVIRONMENT") : null);
          
      oneopsPlatform = (System.getProperty("ONEOPS_PLATFORM") != null) ? 
                          System.getProperty("ONEOPS_PLATFORM") : 
                            (System.getenv("ONEOPS_PLATFORM") != null ? System.getenv("ONEOPS_PLATFORM") : null);
          
      oneopsUserId = (System.getProperty("ONEOPS_USER_ID") != null) ? 
                        System.getProperty("ONEOPS_USER_ID") : 
                          (System.getenv("ONEOPS_USER_ID") != null ? System.getenv("ONEOPS_USER_ID") : null);
                    
      oneopsComponents = (System.getProperty("ONEOPS_COMPONENTS") != null) ? 
                            System.getProperty("ONEOPS_COMPONENTS") : 
                              (System.getenv("ONEOPS_COMPONENTS") != null ? System.getenv("ONEOPS_COMPONENTS") : null);
      
      oneopsVariables = (System.getProperty("ONEOPS_VARIABLES") != null) ? 
                            System.getProperty("ONEOPS_VARIABLES") : 
                              (System.getenv("ONEOPS_VARIABLES") != null ? System.getenv("ONEOPS_VARIABLES") : null);
