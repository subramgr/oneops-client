...
public class Environment implements Serializable {
   ...
   * @param comments
   */
  public Environment(Long ciId, String ciName, String ciClassName, String impl, String nsPath, String ciGoid, String comments, String ciState, Long lastAppliedRfcId, String createdBy,
    Object updatedBy, Long created, Long updated, Long nsId, CiAttributes ciAttributes, AttrProps attrProps, Map<String, Cloud> clouds) {
    this.ciId = ciId;
    this.ciName = ciName;
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(ciId).append(ciName).append(ciClassName).append(impl).append(nsPath).append(ciGoid).append(comments).append(ciState).append(lastAppliedRfcId).append(createdBy)
      .append(updatedBy).append(created).append(updated).append(nsId).append(ciAttributes).append(attrProps).append(clouds).append(additionalProperties).toHashCode();
  }
  ...
  public boolean equals(Object other) {
    ...
    return new EqualsBuilder().append(ciId, rhs.ciId).append(ciName, rhs.ciName).append(ciClassName, rhs.ciClassName).append(impl, rhs.impl).append(nsPath, rhs.nsPath).append(ciGoid, rhs.ciGoid)
      .append(comments, rhs.comments).append(ciState, rhs.ciState).append(lastAppliedRfcId, rhs.lastAppliedRfcId).append(createdBy, rhs.createdBy).append(updatedBy, rhs.updatedBy)
      .append(created, rhs.created).append(updated, rhs.updated).append(nsId, rhs.nsId).append(ciAttributes, rhs.ciAttributes).append(attrProps, rhs.attrProps).append(clouds, rhs.clouds)
  ...
  public static class CiAttributes {
     ...
     * @param autoscale
     */
    public CiAttributes(String debug, String codpmt, String profile, String description, String availability, String monitoring, String autoscale, String adminstatus, String globalDns, String logging,
      String dpmtdelay, String subdomain, String customMonitor, String autoreplace, String autorepair) {
      this.debug = debug;
      this.codpmt = codpmt;
    ...
    @Override
    public int hashCode() {
      return new HashCodeBuilder().append(debug).append(codpmt).append(profile).append(description).append(availability).append(monitoring).append(autoscale).append(adminstatus).append(globalDns)
        .append(logging).append(dpmtdelay).append(subdomain).append(customMonitor).append(autoreplace).append(autorepair).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
      ...
      return new EqualsBuilder().append(debug, rhs.debug).append(codpmt, rhs.codpmt).append(profile, rhs.profile).append(description, rhs.description).append(availability, rhs.availability)
        .append(monitoring, rhs.monitoring).append(autoscale, rhs.autoscale).append(adminstatus, rhs.adminstatus).append(globalDns, rhs.globalDns).append(logging, rhs.logging)
        .append(dpmtdelay, rhs.dpmtdelay).append(subdomain, rhs.subdomain).append(customMonitor, rhs.customMonitor).append(autoreplace, rhs.autoreplace).append(autorepair, rhs.autorepair)
        .append(additionalProperties, rhs.additionalProperties).isEquals();
    }
  ...
  public static class Cloud {
    ...
    public boolean equals(Object other) {
      ...
      return new EqualsBuilder().append(cloudId, rhs.cloudId).append(adminstatus, rhs.adminstatus).append(dpmtOrder, rhs.dpmtOrder).append(pctScale, rhs.pctScale).append(priority, rhs.priority)
        .append(additionalProperties, rhs.additionalProperties).isEquals();
    }
