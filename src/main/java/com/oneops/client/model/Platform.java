...
public class Platform implements Serializable {
   ...
   */
  public Platform(Long rfcId, Long releaseId, Long ciId, String nsPath, String ciClassName, Object impl, String ciName, String ciGoid, String ciState, Object rfcAction, Object releaseType,
    String createdBy, String updatedBy, Object rfcCreatedBy, Object rfcUpdatedBy, Long execOrder, Long lastAppliedRfcId, Object comments, Boolean isActiveInRelease, Object rfcCreated,
    Object rfcUpdated, Long created, Long updated, CiAttributes ciAttributes, CiBaseAttributes ciBaseAttributes, CiAttrProps ciAttrProps, List<Object> linksTo, List<Consume> consumes) {
    this.rfcId = rfcId;
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(rfcId).append(releaseId).append(ciId).append(nsPath).append(ciClassName).append(impl).append(ciName).append(ciGoid).append(ciState).append(rfcAction)
      .append(releaseType).append(createdBy).append(updatedBy).append(rfcCreatedBy).append(rfcUpdatedBy).append(execOrder).append(lastAppliedRfcId).append(comments).append(isActiveInRelease)
      .append(rfcCreated).append(rfcUpdated).append(created).append(updated).append(ciAttributes).append(ciBaseAttributes).append(ciAttrProps).append(linksTo).append(consumes).toHashCode();
  }
  ...
  public boolean equals(Object other) {
    ...
    return new EqualsBuilder().append(rfcId, rhs.rfcId).append(releaseId, rhs.releaseId).append(ciId, rhs.ciId).append(nsPath, rhs.nsPath).append(ciClassName, rhs.ciClassName).append(impl, rhs.impl)
      .append(ciName, rhs.ciName).append(ciGoid, rhs.ciGoid).append(ciState, rhs.ciState).append(rfcAction, rhs.rfcAction).append(releaseType, rhs.releaseType).append(createdBy, rhs.createdBy)
      .append(updatedBy, rhs.updatedBy).append(rfcCreatedBy, rhs.rfcCreatedBy).append(rfcUpdatedBy, rhs.rfcUpdatedBy).append(execOrder, rhs.execOrder).append(lastAppliedRfcId, rhs.lastAppliedRfcId)
      .append(comments, rhs.comments).append(isActiveInRelease, rhs.isActiveInRelease).append(rfcCreated, rhs.rfcCreated).append(rfcUpdated, rhs.rfcUpdated).append(created, rhs.created)
      .append(updated, rhs.updated).append(ciAttributes, rhs.ciAttributes).append(ciBaseAttributes, rhs.ciBaseAttributes).append(ciAttrProps, rhs.ciAttrProps).append(linksTo, rhs.linksTo)
      .append(consumes, rhs.consumes).isEquals();
  }
  ...
  public static class CiAttributes {
     ...
     * @param availability
     */
    public CiAttributes(String replaceAfterRepairs, String majorVersion, String isActive, String description, String replaceAfterMinutes, String source, String availability, String autoscale,
      String autoreplace, String pack, String version, String autorepair) {
    ...
    @Override
    public int hashCode() {
      return new HashCodeBuilder().append(replaceAfterRepairs).append(majorVersion).append(isActive).append(description).append(replaceAfterMinutes).append(source).append(availability)
        .append(autoscale).append(autoreplace).append(pack).append(version).append(autorepair).toHashCode();
    }
    ...
    public boolean equals(Object other) {
      ...
      return new EqualsBuilder().append(replaceAfterRepairs, rhs.replaceAfterRepairs).append(majorVersion, rhs.majorVersion).append(isActive, rhs.isActive).append(description, rhs.description)
        .append(replaceAfterMinutes, rhs.replaceAfterMinutes).append(source, rhs.source).append(availability, rhs.availability).append(autoscale, rhs.autoscale).append(autoreplace, rhs.autoreplace)
  ...
  public static class Consume {
     ...
     * @param comments
     */
    public Consume(Long rfcId, Long releaseId, String nsPath, Long ciRelationId, Long fromCiId, String relationName, Object createdBy, Object updatedBy, Object rfcCreatedBy, Object rfcUpdatedBy,
      Long toCiId, String relationGoid, Object rfcAction, Long execOrder, Object lastAppliedRfcId, Boolean isActiveInRelease, String comments, Long created, Object updated, Object rfcCreated,
      Object rfcUpdated, Object releaseType, Object fromCi, ToCi toCi, RelationAttributes relationAttributes, RelationBaseAttributes relationBaseAttributes, RelationAttrProps relationAttrProps) {
      this.rfcId = rfcId;
      this.releaseId = releaseId;
      this.nsPath = nsPath;
    ...
    @Override
    public int hashCode() {
      return new HashCodeBuilder().append(rfcId).append(releaseId).append(nsPath).append(ciRelationId).append(fromCiId).append(relationName).append(createdBy).append(updatedBy).append(rfcCreatedBy)
        .append(rfcUpdatedBy).append(toCiId).append(relationGoid).append(rfcAction).append(execOrder).append(lastAppliedRfcId).append(isActiveInRelease).append(comments).append(created)
        .append(updated).append(rfcCreated).append(rfcUpdated).append(releaseType).append(fromCi).append(toCi).append(relationAttributes).append(relationBaseAttributes).append(relationAttrProps)
        .toHashCode();
    }
    ...
    public boolean equals(Object other) {
      ...
      return new EqualsBuilder().append(rfcId, rhs.rfcId).append(releaseId, rhs.releaseId).append(nsPath, rhs.nsPath).append(ciRelationId, rhs.ciRelationId).append(fromCiId, rhs.fromCiId)
        .append(relationName, rhs.relationName).append(createdBy, rhs.createdBy).append(updatedBy, rhs.updatedBy).append(rfcCreatedBy, rhs.rfcCreatedBy).append(rfcUpdatedBy, rhs.rfcUpdatedBy)
        .append(toCiId, rhs.toCiId).append(relationGoid, rhs.relationGoid).append(rfcAction, rhs.rfcAction).append(execOrder, rhs.execOrder).append(lastAppliedRfcId, rhs.lastAppliedRfcId)
        .append(isActiveInRelease, rhs.isActiveInRelease).append(comments, rhs.comments).append(created, rhs.created).append(updated, rhs.updated).append(rfcCreated, rhs.rfcCreated)
        .append(rfcUpdated, rhs.rfcUpdated).append(releaseType, rhs.releaseType).append(fromCi, rhs.fromCi).append(toCi, rhs.toCi).append(relationAttributes, rhs.relationAttributes)
        .append(relationBaseAttributes, rhs.relationBaseAttributes).append(relationAttrProps, rhs.relationAttrProps).isEquals();
    }
    ...
    public static class ToCi {
       ...
       * @param comments
       */
      public ToCi(Long rfcId, Long releaseId, Long ciId, String nsPath, String ciClassName, Object impl, String ciName, String ciGoid, String ciState, Object rfcAction, Object releaseType,
        String createdBy, Object updatedBy, Object rfcCreatedBy, Object rfcUpdatedBy, Long execOrder, Long lastAppliedRfcId, String comments, Boolean isActiveInRelease, Object rfcCreated,
        Object rfcUpdated, Long created, Long updated, CiAttributes_ ciAttributes, CiBaseAttributes_ ciBaseAttributes, CiAttrProps_ ciAttrProps) {
        this.rfcId = rfcId;
        this.releaseId = releaseId;
        this.ciId = ciId;
        this.nsPath = nsPath;
      ...
      public int hashCode() {
        return new HashCodeBuilder().append(rfcId).append(releaseId).append(ciId).append(nsPath).append(ciClassName).append(impl).append(ciName).append(ciGoid).append(ciState).append(rfcAction)
          .append(releaseType).append(createdBy).append(updatedBy).append(rfcCreatedBy).append(rfcUpdatedBy).append(execOrder).append(lastAppliedRfcId).append(comments).append(isActiveInRelease)
          .append(rfcCreated).append(rfcUpdated).append(created).append(updated).append(ciAttributes).append(ciBaseAttributes).append(ciAttrProps).toHashCode();
      }
      ...
      public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(rfcId, rhs.rfcId).append(releaseId, rhs.releaseId).append(ciId, rhs.ciId).append(nsPath, rhs.nsPath).append(ciClassName, rhs.ciClassName)
          .append(impl, rhs.impl).append(ciName, rhs.ciName).append(ciGoid, rhs.ciGoid).append(ciState, rhs.ciState).append(rfcAction, rhs.rfcAction).append(releaseType, rhs.releaseType)
          .append(createdBy, rhs.createdBy).append(updatedBy, rhs.updatedBy).append(rfcCreatedBy, rhs.rfcCreatedBy).append(rfcUpdatedBy, rhs.rfcUpdatedBy).append(execOrder, rhs.execOrder)
          .append(lastAppliedRfcId, rhs.lastAppliedRfcId).append(comments, rhs.comments).append(isActiveInRelease, rhs.isActiveInRelease).append(rfcCreated, rhs.rfcCreated)
          .append(rfcUpdated, rhs.rfcUpdated).append(created, rhs.created).append(updated, rhs.updated).append(ciAttributes, rhs.ciAttributes).append(ciBaseAttributes, rhs.ciBaseAttributes)
          .append(ciAttrProps, rhs.ciAttrProps).isEquals();
      }
