...
public class Deployment implements Serializable {
   ...
   * @param ops
   */
  public Deployment(Long deploymentId, Long releaseId, Long maxExecOrder, String nsPath, String deploymentState, String processId, String createdBy, String updatedBy, Object description,
    String comments, Object ops, Long created, Long updated, Map<String, DeploymentStep> rfcInfo) {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(deploymentId).append(releaseId).append(maxExecOrder).append(nsPath).append(deploymentState).append(processId).append(createdBy).append(updatedBy)
      .append(description).append(comments).append(ops).append(created).append(updated).toHashCode();
  }
  ...
  public boolean equals(Object other) {
    ...
    return new EqualsBuilder().append(deploymentId, rhs.deploymentId).append(releaseId, rhs.releaseId).append(maxExecOrder, rhs.maxExecOrder).append(nsPath, rhs.nsPath)
      .append(deploymentState, rhs.deploymentState).append(processId, rhs.processId).append(createdBy, rhs.createdBy).append(updatedBy, rhs.updatedBy).append(description, rhs.description)
      .append(comments, rhs.comments).append(ops, rhs.ops).append(created, rhs.created).append(updated, rhs.updated).isEquals();
  }
