...
public class Release implements Serializable {
   ...
   * @param releaseType
   */
  public Release(Long releaseId, String nsPath, String releaseName, String createdBy, Object commitedBy, String releaseState, Object releaseType, Object description, Long revision,
    Long parentReleaseId, Long created, Long updated, Long nsId, Long releaseStateId, Long ciRfcCount, Long relationRfcCount) {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(releaseId).append(nsPath).append(releaseName).append(createdBy).append(commitedBy).append(releaseState).append(releaseType).append(description).append(revision)
      .append(parentReleaseId).append(created).append(updated).append(nsId).append(releaseStateId).append(ciRfcCount).append(relationRfcCount).toHashCode();
  }
  ...
  public boolean equals(Object other) {
    ...
    return new EqualsBuilder().append(releaseId, rhs.releaseId).append(nsPath, rhs.nsPath).append(releaseName, rhs.releaseName).append(createdBy, rhs.createdBy).append(commitedBy, rhs.commitedBy)
      .append(releaseState, rhs.releaseState).append(releaseType, rhs.releaseType).append(description, rhs.description).append(revision, rhs.revision).append(parentReleaseId, rhs.parentReleaseId)
      .append(created, rhs.created).append(updated, rhs.updated).append(nsId, rhs.nsId).append(releaseStateId, rhs.releaseStateId).append(ciRfcCount, rhs.ciRfcCount)
      .append(relationRfcCount, rhs.relationRfcCount).isEquals();
  }
